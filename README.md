![](https://raw.githubusercontent.com/matteobreschi/bajes/release/v1.0.0/docs/figs/bajes.png)
...
See [`INSTALL`](https://github.com/matteobreschi/bajes/tree/release/v1.0.0/INSTALL.md) for more information.
...
For more details, visit [`gw_tutorial`](https://github.com/matteobreschi/bajes/tree/release/v1.0.0/docs/gw_tutorial.ipynb).
...
For more details, visit [`inf_tutorial`](https://github.com/matteobreschi/bajes/tree/release/v1.0.0/docs/inf_tutorial.ipynb)
or type `python -m bajes --help`.

## Pipeline

![](https://raw.githubusercontent.com/matteobreschi/bajes/release/v1.0.0/docs/figs/pipe.png)
...
For more details, visit [`conifg_example`](https://github.com/matteobreschi/bajes/tree/release/v1.0.0/docs/config_example.ini).
...
visit [`CREDITS`](https://github.com/matteobreschi/bajes/tree/release/v1.0.0/CREDITS.md) for more details.
