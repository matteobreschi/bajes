...
def get_eos_from_spectral_params(ll):
...
class TOVSolver(object):
    ...
    def __init__(self, g0, g1, g2, g3,
        ...
        # initialize EOS
        core_eos    = get_eos_from_spectral_params([g0, g1, g2, g3])
        ...
        if not self.EOS._is_physical(Pmax):
            ...
            logger.warning("Requested parameters [{:.1f},{:.2f},{:.2f},{:.2f}] gave an unphysical EOS.".format(g0, g1, g2, g3))
        else:
